...
class SaveAadharVC: UIViewController, NVActivityIndicatorViewable {
...
extension SaveAadharVC: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension SaveAadharVC: ImageSelected {
